        ...
        <div className='container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col w-[1000px] md:flex-row justify-between space-x-10 mt-8'>
                            ...
                            {paymentMethod === "dc" && (
                                <div className='bg-gray-100 p-4 rounded-lg mb-4'>
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <input type="text" placeholder='Account Number' className='border p-2 w-full rounded' />
                                    </div>
                                    <div className='mb-4'>
                                    ...
                                    <div className='flex justify-between mb-4'>
                                        <div className='mb-4'>
                                            <label htmlFor="" className='block text-gray-700 font-semibold mb-2'>Card CVV</label>
                ...
                <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                    ...
                    <button onClick={handleOrder} className='mt-4 w-full py-2 bg-blue-600 text-white rounded'>
                        Place Order
                    </button>
                </div>
            </div>
