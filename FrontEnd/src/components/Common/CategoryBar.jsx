      ...
      <div className="relative bg-white shadow-md rounded-lg mx-4 my-6">
        <div className="flex items-center px-4 py-3">
          ...
          <button
            ...
            className="flex-none p-2 rounded-full bg-white text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors duration-200 shadow-sm border border-gray-200"
          >
